    ...
    Raphael.el.trigger = function (t) {
        ...
        function l() {
            function o() {
                ...
                })) : (Z = (Y = P) / F, d.css({width: Y + "px", height: Z + "px"})), u.setSize(Y, Z)
            }
            ...
            function O(o) {
                ...
                if (o && o.pageX ? (f = o.pageX, v = o.pageY - e) : (f = event.clientX + document.body.scrollLeft, v = event.clientY + document.body.scrollTop), f < 0 && (f = 0), v < 0 && (v = 0), l(), D.displayMousePosition) {
                    var e = x.scrollTop(), i = d.offset(), a = Math.round(f - i.left), s = Math.round(v - i.top + e),
                        n = Math.round(a - D.mapWidth / 2), r = Math.round(s - D.mapHeight / 2);
            ...
            var Y = D.mapWidth, Z = D.mapHeight, F = Y / Z;
            ...
            D.displayMousePosition && (t('<div class="jsmaps-mouse-position"><div class="xPos">X: 0</div><div class="yPos">Y: 0</div></div>').appendTo(d), t("body").css("cursor", "crosshair")), D.displayViewBox && t('<div class="jsmaps-viewbox-data"><div class="xPos">X: {0}</div><div class="yPos">Y: {0}</div><div class="zoom">Zoom: {0}</div></div>').appendTo(d), "text" === D.stateClickAction && ((M = t('<div class="jsmaps-text"></div>').appendTo(d)).html(D.defaultText), "left" === D.textPosition && (T.css({
                left: "auto",
                right: "0"
            }), H.css({left: "auto", right: "10px"}))), d.mousemove(function (t) {
                O(t)
            }), function () {
                function e(o) {
                    var e = this.data("id"), i = !!this.data("group"), n = i ? this.data("group") : I[e], r = n.enable,
                        l = "mouseover" === o.type, d = l ? n.hoverColor : n.color,
                ...
                var i, l, d, m, h = {"stroke-width": D.strokeWidth || 1}, f = {
                ...
                function o(o) {
                    var e = this.data("id"), i = X[e], n = "mouseover" === o.type, r = n ? i.hoverColor : i.color,
                ...
                for (var e = 0; e < X.length; e++) {
                    ...
                    if (X[e].src && "" !== X[e].src) {
                        ...
                        var d = -X[e].srcWidth / 2 + X[e].xPos, m = -X[e].srcHeight / 2 + X[e].yPos;
                ...
                t("body").on("mousewheel DOMMouseScroll", function (o) {
                    ...
                    initialPosition: {x: D.initialMapX, y: D.initialMapY},
                    originSize: {width: D.mapWidth, height: D.mapHeight}
        ...
        var u, h, f = 0, v = 0, g = null, b = !1, x = t(window), w = x.width(), j = 0, k = !1, y = [], C = [],
            P = d.parent().width(), T = t('<div class="jsmaps"></div>').appendTo(d), z = "jsmaps-" + o();
        T.attr("id", z);
        var M, S, A = [], W = [], E = null, O = window.JSMaps.maps[c.map], D = t.extend(c, O.config), I = O.paths,
            X = O.pins;
